# Known NVIDIA GPU achitectures CudaCpp can be compiled for.
# This list will be used for CUDA_ARCH_NAME = All option
set(cudacpp_known_gpu_archs "30 35 50 52 60 61 70")
set(cudacpp_known_gpu_archs7 "30 35 50 52")
set(cudacpp_known_gpu_archs8 "30 35 50 52 60 61")

################################################################################
# Function for selecting GPU arch flags for nvcc based on CUDA_ARCH_NAME
# Usage:
#   cudacpp_select_nvcc_arch_flags(out_variable)
function(cudacpp_select_nvcc_arch_flags out_variable)
  # List of arch names
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "All")
    set(__cuda_arch_bin ${cudacpp_known_gpu_archs})
  else()
...
# Usage:
#   cudacpp_list_append_if_unique(list_variable arg1 arg2 ...)
function(cudacpp_list_append_if_unique list)
...
# Usage:
#   cudacpp_cuda_compile(<objlist_variable> <cuda_files>)
macro(cudacpp_cuda_compile objlist_variable)
...
if (${CUDA_VERSION} LESS 8.0)
  set(cudacpp_known_gpu_archs ${cudacpp_known_gpu_archs7})
  list(APPEND CUDA_NVCC_FLAGS "-D_MWAITXINTRIN_H_INCLUDED")
  list(APPEND CUDA_NVCC_FLAGS "-D__STRICT_ANSI__")
elseif (${CUDA_VERSION} LESS 9.0)
  set(cudacpp_known_gpu_archs ${cudacpp_known_gpu_archs8})
  list(APPEND CUDA_NVCC_FLAGS "-D_MWAITXINTRIN_H_INCLUDED")
  list(APPEND CUDA_NVCC_FLAGS "-D__STRICT_ANSI__")
else()
...
list(APPEND EventDetect_DEPENDENCY_LIBS ${CUDA_CUDART_LIBRARY})
...
if (NOT ";${CUDA_NVCC_FLAGS};" MATCHES ";-gencode;")
  cudacpp_select_nvcc_arch_flags(NVCC_FLAGS_EXTRA)
...
if(CUDA_CUDA_LIB)
  ...
  list(APPEND EventDetect_DEPENDENCY_LIBS ${CUDA_CUDA_LIB})
else()
...
if(CUDA_NVRTC_LIB)
  ...
  list(APPEND EventDetect_DEPENDENCY_LIBS ${CUDA_NVRTC_LIB})
else()
...
foreach(diag cc_clobber_ignored integer_sign_change useless_using_declaration set_but_not_used)
  cudacpp_list_append_if_unique(CUDA_NVCC_FLAGS -Xcudafe --diag_suppress=${diag})
endforeach()

# Set C++11 support
set(CUDA_PROPAGATE_HOST_FLAGS OFF)
cudacpp_list_append_if_unique(CUDA_NVCC_FLAGS "-std=c++11")
cudacpp_list_append_if_unique(CUDA_NVCC_FLAGS "-Xcompiler -fPIC")
